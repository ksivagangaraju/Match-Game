...
class App extends Component {
  ...
  onClickMatching = id => {
    const {score, randomImage} = this.state
  ...
  render() {
    const {score, seconds, activeTabId, randomImage, isGameOver} = this.state
        ...
        {isGameOver ? (
          <div className="match-game-container">
            <div className="game-over-container">
              ...
              <p className="score-counted">{score}</p>
              <button
                type="button"
                className="play-again-button"
                onClick={this.onClickPlayAgainGame}
              >
                <img
            ...
            <ul className="tabs-container">
              {tabsList.map(eachItem => (
                <TabItem
                  key={eachItem.tabId}
                  tabItem={eachItem}
                  isChecked={eachItem.tabId === activeTabId}
                  onClickTab={this.onClickTab}
                />
              ))}
            </ul>
            <ul className="image-thumbnails-container">
